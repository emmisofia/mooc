...
public class MistaLahtienTest {
    ...
    private void testaa(int[] lukupari) {
        ...
        ReflectionUtils.newInstanceOfClass(MihinJaMista.class);
        MihinJaMista.main(new String[0]);
        ...
        int rivienLkm;
        if(lukupari[0] < lukupari[1]) {
            rivienLkm = 0;
        } else {
            rivienLkm = lukupari[0]  - lukupari[1] + 1;
        }
        ...
        if(ekaLuku != lukupari[1]) {
            fail("Syötteellä " + lukupari[0] + ", " + lukupari[1] + " ensimmäisen tulostettavan luvun pitäisi olla " + lukupari[1] + ", nyt se oli " + ekaLuku);
        }
        
        int vikaLuku = otaLukuLopusta(tulostus);
        if(vikaLuku != lukupari[0]) {
            fail("Syötteellä " + lukupari[0] + ", " + lukupari[1] + " viimeisen tulostettavan luvun pitäisi olla " + lukupari[0] + ", nyt se oli " + vikaLuku);
        }
    }
