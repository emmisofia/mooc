...
@Points("02-22")
public class KolmanneksiViimeinenArvoTest {
    ...
    @Test
    public void testi() {
        String[][] syotteet = {{"Terho", "Elina", "Aleksi", "Mari", "", "Elina"}, {"Elina", "Aleksi", "Mari", "", "Elina"}, {"Eka", "Toka", "Kolmas", "Neljäs", "Viides", "Kuudes", "Seitsemäs", "", "Viides"}};
    ...
    private void tarkista(String... merkkijonot) {
        ...
        io.setSysIn(in);
        callMain(KolmanneksiViimeinenArvo.class);
